...
const I18N = {
  en: {
    ...
    "nav.stories": "Stories", "nav.store": "Visit Store", "nav.faq": "FAQ", "nav.cart": "Cart",
    ...
    "trk.h": "Watch your order, every step <span class=\"demo-tag\">DEMO</span>", "trk.p": "Once it's out for delivery, you'll see exactly where it is, like tracking a pizza.",
    "trk.s1": "Order confirmed", "trk.s2": "Packing your order", "trk.s3": "Out for delivery", "trk.s4": "Delivered",
    "trk.driver": "Your driver", "trk.eta": "Arriving in", "trk.live": "SAMPLE",
    "trk.note": "This is a sample, not a real order — a preview of how live delivery tracking will look once it's turned on.",
    "demo.tag": "DEMO",
    ...
    "stories.p": "Quick reads on where it all comes from — here if you're curious, never in the way of shopping.",
    "stories.1t": "The story of hookah", "stories.1f": "Born in the court of a 16th-century Indian emperor.",
    "stories.1a": "Hookah traces back to the courts of 16th-century India and Persia, where it became a centerpiece of hospitality and long conversation. Passed between friends, it was always about slowing down and sharing the moment — the same spirit it carries today.",
    "stories.2t": "The art of the cigar", "stories.2f": "Hand-rolled the same way for over 200 years.",
    "stories.2a": "A fine cigar is still made almost entirely by hand, from selecting and aging the leaf to the roller's final touch. That patience is the whole point — a craft meant to be savored slowly, never rushed.",
    "stories.3t": "Rolling paper, done right", "stories.3f": "The thinner the paper, the cleaner the burn.",
    "stories.3a": "Good rolling paper is quietly technical — the right thickness, a clean even burn, and a taste that stays out of the way. From classic rice to ultra-thin, the paper you choose shapes the whole experience.",
    ...
    "faq.eyebrow": "Real talk", "faq.h": "You asked. We answered.",
    "faq.q1": "Do you deliver, and how fast?", "faq.a1": "Yes, and fast. If you're within about 5 miles of our Southland Blvd shop, our own driver brings it the same day, usually in under an hour. Farther out in Orlando? Order online and we ship the eligible stuff straight to your door, or grab it in store.",
    "faq.q2": "How much is delivery or shipping?", "faq.a2": "Local delivery is free over $50, and a small flat fee under that. Shipping is a flat rate, free on eligible orders over $75. No surprises, you see it before you pay.",
    "faq.q6": "Can you ship vapes to me?", "faq.a6": "We wish, but no. Federal law (the PACT Act) means vapes, e-liquids and tobacco can't be shipped by anyone, so those are local-delivery or in-store only. Glass, accessories and more? Those we'll happily ship nationwide.",
    "faq.q3": "Where are you located?", "faq.a3": "7400 Southland Blvd #113, Orlando, FL 32809, right by the Florida Mall just off Orange Blossom Trail. Come say hi.",
    "faq.q4": "What are your hours?", "faq.a4": "Every single day, 10 AM to 11 PM. Late-night run? We've got you.",
    "faq.q5": "Do I really need to be 21?", "faq.a5": "Yep, 21 and up, no exceptions. It's the same quick ID check you'd get at a liquor store, takes under a minute, on delivery or in store.",
  ...
  es: {
    ...
    "nav.stories": "Historias", "nav.store": "Visítanos", "nav.faq": "Preguntas", "nav.cart": "Carrito",
    ...
    "trk.h": "Sigue tu pedido, paso a paso <span class=\"demo-tag\">DEMO</span>", "trk.p": "En cuanto salga a entrega, verás exactamente dónde está, como cuando rastreas una pizza.",
    "trk.s1": "Pedido confirmado", "trk.s2": "Preparando tu pedido", "trk.s3": "En camino", "trk.s4": "Entregado",
    "trk.driver": "Tu chofer", "trk.eta": "Llega en", "trk.live": "EJEMPLO",
    "trk.note": "Esto es un ejemplo, no un pedido real — una vista previa de cómo se verá el rastreo en vivo cuando lo activemos.",
    "demo.tag": "DEMO",
    ...
    "stories.p": "Lecturas cortas sobre el origen de todo — aquí si te da curiosidad, sin estorbar la compra.",
    "stories.1t": "La historia de la hookah", "stories.1f": "Nació en la corte de un emperador indio del siglo XVI.",
    "stories.1a": "La hookah se remonta a las cortes de la India y Persia del siglo XVI, donde se volvió símbolo de hospitalidad y buenas conversaciones. Compartida entre amigos, siempre se trató de bajar el ritmo y disfrutar el momento — el mismo espíritu que conserva hoy.",
    "stories.2t": "El arte del cigarro", "stories.2f": "Enrollado a mano igual desde hace más de 200 años.",
    "stories.2a": "Un buen cigarro se sigue haciendo casi todo a mano, desde seleccionar y añejar la hoja hasta el toque final del torcedor. Esa paciencia es justo el punto — un arte para disfrutar despacio, sin apuros.",
    "stories.3t": "El papel de fumar, bien hecho", "stories.3f": "Entre más fino el papel, más limpia la quema.",
    "stories.3a": "Un buen papel de fumar es discretamente técnico — el grosor justo, una quema pareja y limpia, y un sabor que no estorba. Del clásico de arroz al ultra fino, el papel que eliges marca toda la experiencia.",
    ...
    "faq.eyebrow": "Sin vueltas", "faq.h": "Preguntaste. Te respondimos.",
    "faq.q1": "¿Hacen entregas, y qué tan rápido?", "faq.a1": "Sí, y rápido. Si estás dentro de unas 5 millas de nuestra tienda en Southland Blvd, nuestro propio chofer te lo lleva el mismo día, casi siempre en menos de una hora. ¿Más lejos en Orlando? Ordena en línea y te enviamos lo elegible directo a tu puerta, o lo recoges en tienda.",
    "faq.q2": "¿Cuánto cuesta la entrega o el envío?", "faq.a2": "La entrega local es gratis en pedidos de más de $50, y una pequeña tarifa fija por debajo de eso. El envío es tarifa fija, gratis en pedidos elegibles de más de $75. Sin sorpresas, lo ves antes de pagar.",
    "faq.q6": "¿Pueden enviarme vapes?", "faq.a6": "Ojalá, pero no. Por ley federal (la Ley PACT), los vapes, e-líquidos y el tabaco no los puede enviar nadie, así que esos son solo entrega local o en tienda. ¿Vidrio, accesorios y más? Esos con gusto te los enviamos a todo el país.",
    "faq.q3": "¿Dónde están ubicados?", "faq.a3": "7400 Southland Blvd #113, Orlando, FL 32809, justo al lado del Florida Mall, cerca de Orange Blossom Trail. Pásate a saludar.",
    "faq.q4": "¿Cuál es su horario?", "faq.a4": "Todos los días, de 10 AM a 11 PM. ¿Antojo de última hora? Te cubrimos.",
    "faq.q5": "¿De verdad necesito tener 21 años?", "faq.a5": "Sí, 21 o más, sin excepciones. Es el mismo chequeo rápido de identificación que te piden en una licorería, tarda menos de un minuto, en la entrega o en tienda.",
